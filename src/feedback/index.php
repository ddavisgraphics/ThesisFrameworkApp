...
<section class="wrapper">
    <div class="container">
        <h2> Feedback </h2>
        <p> Your feedback is appreciated, please comeback and give feedback any time during your progress of this application.  Feel free to report problems, or bugs using thing form.  </p>
