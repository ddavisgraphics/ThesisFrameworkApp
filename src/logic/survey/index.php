<?php
    ...
    $form->addField(array(
        'name'       => 'codeInput',
        'type'       => 'plaintext',
        'label'      => 'Optional Challenge!  Use either langauge to take a variable and change that variable to be a string with that starts with "_User_".',
