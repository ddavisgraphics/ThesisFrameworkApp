...
<script>
    ...
    var simple;
    $('.simpleEditor').each(function(index){
        simple = ace.edit(this);
        simple.getSession().setUseWrapMode(true);
        simple.setTheme("ace/theme/monokai");
        simple.session.setOption("useWorker", false);
    });
